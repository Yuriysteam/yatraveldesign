...
- ZIP или `SKILL.md` можно прислать прямо в чат. ZIP с несколькими `SKILL.md` публикуется целиком как один пакет: при установке его содержимое распаковывается в папку skills и устанавливает весь набор. Для одиночного скила одинаковое поле `name` обновляет существующий skill, а не создаёт дубликат.
